...
export default function Account() {
  ...
  return (
    <div> 
      ...
      <div className="container mx-auto p-4 flex flex-col items-center justify-center h-screen relative -top-28">
        <div className="bg-blue-900 text-white rounded-lg shadow-lg p-8 w-full max-w-sm sm:max-w-md md:max-w-lg lg:max-w-xl xl:max-w-2xl">
          ...
          <div className="mt-6 flex flex-col space-y-3 sm:space-y-0 sm:flex-row sm:space-x-4">
